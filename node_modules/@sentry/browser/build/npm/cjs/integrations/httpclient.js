...
function _parseCookieHeaders(
  ...
  try {
    ...
    debugBuild.DEBUG_BUILD && core.logger.log(`Could not extract cookies from header ${cookieHeader}`);
  }
  ...
  if (_shouldCaptureResponse(options, xhr.status, xhr.responseURL)) {
    ...
    if (_shouldSendDefaultPii()) {
      try {
        ...
        debugBuild.DEBUG_BUILD && core.logger.log('Could not extract cookies from response headers');
      }

      try {
        responseHeaders = _getXHRResponseHeaders(xhr);
      } catch (e) {
        debugBuild.DEBUG_BUILD && core.logger.log('Could not extract headers from response');
      }
